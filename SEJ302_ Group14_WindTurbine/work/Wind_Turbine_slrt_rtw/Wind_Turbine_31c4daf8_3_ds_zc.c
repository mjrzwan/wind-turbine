...
{
  PmRealVector out;
  real_T Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_3_Ideal_Prop7;
  ...
  out = t16->mZC;
  Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_3_Ideal_Prop7 = -X_idx_6 +
    U_idx_0;
  if (-X_idx_6 > 0.003) {
  ...
  if ((M_idx_14 == 0) && (M_idx_13 != 0)) {
    t0 = 9.9999999999999991E-11 - (-(U_idx_1 + -24.0));
  } else {
    t0 = 0.0;
  }

  if (M_idx_13 != 0) {
    t1 = -(U_idx_1 + -24.0) - 0.005;
  } else {
    t1 = 0.0;
  }

  if (M_idx_8 == 0) {
    t2 = -0.3 - Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_3_Ideal_Prop7;
  } else {
    t2 = 0.0;
  }

  if (M_idx_16 != 0) {
    t3 = -(U_idx_2 + -24.0) - 0.005;
  } else {
    t3 = 0.0;
  }
  ...
  out.mX[1] = intrm_sf_mf_41 - 1.0E-12;
  out.mX[2] = (real_T)(X_idx_0 + X_idx_24 > -1.01325);
  out.mX[3] = intrm_sf_mf_37 - 1.0E-12;
  out.mX[4] = t0;
  out.mX[5] = t1;
  out.mX[6] = X_idx_8 - 0.1;
  out.mX[7] = t2;
  out.mX[8] = t3;
  out.mX[9] = Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_3_Ideal_Prop7 -
    0.3;
  out.mX[10] = t4;
  out.mX[11] = intrm_sf_mf_21 - 1.0E-12;
  out.mX[12] = t5;
  out.mX[13] = t6;
  out.mX[14] = t7;
  out.mX[15] = t8;
  ...
  out.mX[18] = X_idx_6;
  out.mX[19] = U_idx_0;
  out.mX[20] = intrm_sf_mf_17 - 1.0E-12;
  out.mX[21] = intrm_sf_mf_17 - 1.0E-12;
  out.mX[22] = intrm_sf_mf_21 - 1.0E-12;
  out.mX[23] = U_idx_1;
  out.mX[24] = X_idx_0 - -1.01325;
  out.mX[25] = M_idx_10 == 0 ? -X_idx_8 : 0.0;
  out.mX[26] = (X_idx_3 * 0.005 + 0.0001) - 0.0001;
  out.mX[27] = X_idx_4;
