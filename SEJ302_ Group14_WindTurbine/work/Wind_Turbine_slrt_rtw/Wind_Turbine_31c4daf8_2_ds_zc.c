...
int32_T Wind_Turbine_31c4daf8_2_ds_zc(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t15, NeDsMethodOutput *t16)
{
  PmRealVector out;
  real_T Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_2_Ideal_Prop7;
  ...
  out = t16->mZC;
  Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_2_Ideal_Prop7 = -X_idx_6 +
    U_idx_0;
  if (-X_idx_6 > 0.003) {
  ...
  if (M_idx_8 == 0) {
    t3 = -0.3 - Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_2_Ideal_Prop7;
  } else {
    t3 = 0.0;
  }
  ...
  if ((M_idx_17 == 0) && (M_idx_16 != 0)) {
    U_idx_1 = 9.9999999999999991E-11 - (-(U_idx_2 + -24.0));
  } else {
    U_idx_1 = 0.0;
  }

  if (M_idx_12 == 0) {
    U_idx_2 = X_idx_4 - -1.4967;
  } else {
    U_idx_2 = 0.0;
  }
  ...
  if (M_idx_5 != 0) {
    U_idx_0 = -X_idx_6 - 0.003;
  } else {
    U_idx_0 = 0.0;
  }

  out.mX[0] = X_idx_1 - -1.01325;
  out.mX[1] = X_idx_0 - -1.01325;
  out.mX[2] = t0;
  ...
  out.mX[7] = t3;
  out.mX[8] = t4;
  out.mX[9] = intrm_sf_mf_21 - 1.0E-12;
  out.mX[10] = intrm_sf_mf_21 - 1.0E-12;
  out.mX[11] = t5;
  out.mX[12] = M_idx_10 == 0 ? -X_idx_8 : 0.0;
  out.mX[13] = Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_2_Ideal_Prop7 -
    0.3;
  out.mX[14] = t6;
  out.mX[15] = t7;
  out.mX[16] = (real_T)(X_idx_0 + X_idx_24 > -1.01325);
  out.mX[17] = t8;
  out.mX[18] = U_idx_1;
  out.mX[19] = X_idx_8 - 0.1;
