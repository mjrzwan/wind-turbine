...
{
  PmIntVector out;
  real_T Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif0;
  real_T Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif1;
  ...
  out = t10->mASSERT;
  Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif0 = -X_idx_0 +
    X_idx_9;
  Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif1 = -X_idx_1 +
    X_idx_11;
  if (-X_idx_6 > 0.003) {
  ...
  t0[56ULL] = 1;
  t0[57ULL] = (int32_T)
    (Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif0 *
     Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif0 +
  ...
  t0[61ULL] = 1;
  t0[62ULL] = (int32_T)
    (Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif1 *
     Nacelle_Pitch_System_Hydraulic_Hydraulic_Actuator_1_Fixed_Orif1 +
