...
int32_T Wind_Turbine_31c4daf8_1_ds_zc(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t25, NeDsMethodOutput *t26)
{
  ...
  tlu2_1d_linear_nearest_value((void *)&h_efOut, (void *)g_efOut.mField0, (void *)
    ...
    &_in1ivar);
  out.mX[0] = (real_T)(X[63ULL] > 0.0);
  out.mX[1] = (real_T)(X[48ULL] > 0.0);
  out.mX[2] = (real_T)(X[33ULL] > 0.0);
  out.mX[3] = (real_T)(X[11ULL] > 0.0);
  out.mX[4] = X[7ULL] * t13 - d_efOut[0];
  out.mX[5] = X[5ULL] * intrm_sf_mf_13 - b_efOut[0];
  out.mX[6] = X[3ULL] * t15 - h_efOut[0];
  out.mX[7] = X[1ULL] * t14 - f_efOut[0];
  (void)sys;
  (void)t26;
  return 0;
}
