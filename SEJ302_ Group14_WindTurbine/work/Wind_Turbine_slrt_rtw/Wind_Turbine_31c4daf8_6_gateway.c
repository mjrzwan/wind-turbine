...
#include "nesl_rtw.h"
#include "Wind_Turbine_31c4daf8_6.h"
#include "Wind_Turbine_31c4daf8_6_gateway.h"

void Wind_Turbine_31c4daf8_6_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 1, 0.001, 0, 0, 0.001, 0, 0,
    0, 0, (SscLoggingSetting) 0, 579692665, };
  ...
  Wind_Turbine_31c4daf8_6_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("Wind_Turbine/Solver Configuration_6",
    1,
    &dae,
    &solverparams,
    &modelparams,
