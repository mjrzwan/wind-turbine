...
int32_T Wind_Turbine_31c4daf8_1_ds_log(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t39, NeDsMethodOutput *t40)
{
  ...
  t4[91ULL] = X[28ULL];
  t4[92ULL] = 0.0;
  t4[93ULL] = -(X[28ULL] - X[23ULL]) / -1.0;
  t4[94ULL] = t7;
  t4[95ULL] = t7 * 0.60000000000000009;
  t4[96ULL] = t7 * -1.6;
  t4[97ULL] = 300.0;
  t4[98ULL] = X[23ULL];
  t4[99ULL] = 0.0;
  ...
  t4[103ULL] = X[12ULL];
  t4[104ULL] = 0.0;
  t4[105ULL] = -(X[12ULL] - X[23ULL]) / -1.0;
  t4[106ULL] = X[15ULL];
  t4[107ULL] = X[15ULL] * -0.6;
  t4[108ULL] = X[15ULL] * -0.39999999999999997;
  t4[109ULL] = 300.0;
  t4[110ULL] = X[25ULL];
  t4[111ULL] = 0.0;
  t4[112ULL] = 0.0;
  ...
  t4[123ULL] = X[29ULL];
  t4[124ULL] = 0.0;
  t4[125ULL] = -(X[29ULL] - X[25ULL]) / -1.0;
  t4[126ULL] = t9;
  t4[127ULL] = t9 * 0.55555555555555569;
  t4[128ULL] = t9 * -1.5555555555555558;
  t4[129ULL] = 300.0;
  t4[130ULL] = X[25ULL];
  t4[131ULL] = 0.0;
  t4[132ULL] = X[29ULL];
  ...
  t4[135ULL] = X[23ULL];
  t4[136ULL] = 0.0;
  t4[137ULL] = -(X[23ULL] - X[25ULL]) / -1.0;
  t4[138ULL] = X[22ULL];
  t4[139ULL] = X[22ULL] * -0.55555555555555558;
  t4[140ULL] = X[22ULL] * -0.44444444444444448;
  t4[141ULL] = 300.0;
  t4[142ULL] = X[27ULL];
  t4[143ULL] = 0.0;
  t4[144ULL] = 0.0;
  ...
  t4[155ULL] = X[30ULL];
  t4[156ULL] = 0.0;
  t4[157ULL] = -(X[30ULL] - X[27ULL]) / -1.0;
  t4[158ULL] = X[24ULL];
  t4[159ULL] = X[24ULL] * 0.5;
  t4[160ULL] = X[24ULL] * -1.5;
  t4[161ULL] = 300.0;
  t4[162ULL] = X[27ULL];
  t4[163ULL] = 0.0;
  t4[164ULL] = X[30ULL];
  ...
  t4[167ULL] = X[25ULL];
  t4[168ULL] = 0.0;
  t4[169ULL] = -(X[25ULL] - X[27ULL]) / -1.0;
  t4[170ULL] = X[24ULL];
  t4[171ULL] = X[24ULL] * -0.5;
  t4[172ULL] = X[24ULL] * -0.5;
  t4[173ULL] = 300.0;
  ...
  t4[184ULL] = X[31ULL];
  t4[185ULL] = 0.0;
  t4[186ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[187ULL] = X[31ULL];
  t4[188ULL] = 0.0;
  t4[189ULL] = -(X[31ULL] -
                 ...
                 -6.25) / -1.0;
  t4[190ULL] = t13;
  t4[191ULL] = t13 * 0.33333333333333331;
  t4[192ULL] = t13 * -1.3333333333333333;
  t4[193ULL] = 300.0;
  ...
  t4[196ULL] = X[31ULL];
  t4[197ULL] = X[27ULL];
  t4[198ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[199ULL] = X[27ULL];
  t4[200ULL] = 0.0;
  t4[201ULL] = -(X[27ULL] -
                 ...
                 -6.25) / -1.0;
  t4[202ULL] = t13;
  t4[203ULL] = t13 * -0.33333333333333331;
  t4[204ULL] = t13 * -0.66666666666666663;
  t4[205ULL] = 300.0;
  t4[206ULL] = 0.0;
  ...
  t4[289ULL] = X[43ULL];
  t4[290ULL] = 0.0;
  t4[291ULL] = -(X[43ULL] - X[39ULL]) / -1.0;
  t4[292ULL] = t15;
  t4[293ULL] = t15 * 0.60000000000000009;
  t4[294ULL] = t15 * -1.6;
  t4[295ULL] = 300.0;
  t4[296ULL] = X[39ULL];
  t4[297ULL] = 0.0;
  ...
  t4[301ULL] = X[34ULL];
  t4[302ULL] = 0.0;
  t4[303ULL] = -(X[34ULL] - X[39ULL]) / -1.0;
  t4[304ULL] = X[37ULL];
  t4[305ULL] = X[37ULL] * -0.6;
  t4[306ULL] = X[37ULL] * -0.39999999999999997;
  t4[307ULL] = 300.0;
  t4[308ULL] = X[41ULL];
  t4[309ULL] = 0.0;
  t4[310ULL] = 0.0;
  ...
  t4[321ULL] = X[44ULL];
  t4[322ULL] = 0.0;
  t4[323ULL] = -(X[44ULL] - X[41ULL]) / -1.0;
  t4[324ULL] = t17;
  t4[325ULL] = t17 * 0.55555555555555569;
  t4[326ULL] = t17 * -1.5555555555555558;
  t4[327ULL] = 300.0;
  t4[328ULL] = X[41ULL];
  t4[329ULL] = 0.0;
  t4[330ULL] = X[44ULL];
  ...
  t4[333ULL] = X[39ULL];
  t4[334ULL] = 0.0;
  t4[335ULL] = -(X[39ULL] - X[41ULL]) / -1.0;
  t4[336ULL] = X[38ULL];
  t4[337ULL] = X[38ULL] * -0.55555555555555558;
  t4[338ULL] = X[38ULL] * -0.44444444444444448;
  t4[339ULL] = 300.0;
  t4[340ULL] = X[42ULL];
  t4[341ULL] = 0.0;
  t4[342ULL] = 0.0;
  ...
  t4[353ULL] = X[45ULL];
  t4[354ULL] = 0.0;
  t4[355ULL] = -(X[45ULL] - X[42ULL]) / -1.0;
  t4[356ULL] = X[40ULL];
  t4[357ULL] = X[40ULL] * 0.5;
  t4[358ULL] = X[40ULL] * -1.5;
  t4[359ULL] = 300.0;
  t4[360ULL] = X[42ULL];
  t4[361ULL] = 0.0;
  t4[362ULL] = X[45ULL];
  ...
  t4[365ULL] = X[41ULL];
  t4[366ULL] = 0.0;
  t4[367ULL] = -(X[41ULL] - X[42ULL]) / -1.0;
  t4[368ULL] = X[40ULL];
  t4[369ULL] = X[40ULL] * -0.5;
  t4[370ULL] = X[40ULL] * -0.5;
  t4[371ULL] = 300.0;
  ...
  t4[382ULL] = X[46ULL];
  t4[383ULL] = 0.0;
  t4[384ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[385ULL] = X[46ULL];
  t4[386ULL] = 0.0;
  t4[387ULL] = -(X[46ULL] -
                 ...
                 -6.25) / -1.0;
  t4[388ULL] = X[16ULL];
  t4[389ULL] = X[16ULL] * 0.33333333333333331;
  t4[390ULL] = X[16ULL] * -1.3333333333333333;
  t4[391ULL] = 300.0;
  ...
  t4[394ULL] = X[46ULL];
  t4[395ULL] = X[42ULL];
  t4[396ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[397ULL] = X[42ULL];
  t4[398ULL] = 0.0;
  t4[399ULL] = -(X[42ULL] -
                 ...
                 -6.25) / -1.0;
  t4[400ULL] = X[16ULL];
  t4[401ULL] = X[16ULL] * -0.33333333333333331;
  t4[402ULL] = X[16ULL] * -0.66666666666666663;
  t4[403ULL] = 300.0;
  t4[404ULL] = 0.0;
  ...
  t4[487ULL] = X[58ULL];
  t4[488ULL] = 0.0;
  t4[489ULL] = -(X[58ULL] - X[54ULL]) / -1.0;
  t4[490ULL] = t23;
  t4[491ULL] = t23 * 0.60000000000000009;
  t4[492ULL] = t23 * -1.6;
  t4[493ULL] = 300.0;
  t4[494ULL] = X[54ULL];
  t4[495ULL] = 0.0;
  ...
  t4[499ULL] = X[49ULL];
  t4[500ULL] = 0.0;
  t4[501ULL] = -(X[49ULL] - X[54ULL]) / -1.0;
  t4[502ULL] = X[52ULL];
  t4[503ULL] = X[52ULL] * -0.6;
  t4[504ULL] = X[52ULL] * -0.39999999999999997;
  t4[505ULL] = 300.0;
  t4[506ULL] = X[56ULL];
  t4[507ULL] = 0.0;
  t4[508ULL] = 0.0;
  ...
  t4[519ULL] = X[59ULL];
  t4[520ULL] = 0.0;
  t4[521ULL] = -(X[59ULL] - X[56ULL]) / -1.0;
  t4[522ULL] = t25;
  t4[523ULL] = t25 * 0.55555555555555569;
  t4[524ULL] = t25 * -1.5555555555555558;
  t4[525ULL] = 300.0;
  t4[526ULL] = X[56ULL];
  t4[527ULL] = 0.0;
  t4[528ULL] = X[59ULL];
  ...
  t4[531ULL] = X[54ULL];
  t4[532ULL] = 0.0;
  t4[533ULL] = -(X[54ULL] - X[56ULL]) / -1.0;
  t4[534ULL] = X[53ULL];
  t4[535ULL] = X[53ULL] * -0.55555555555555558;
  t4[536ULL] = X[53ULL] * -0.44444444444444448;
  t4[537ULL] = 300.0;
  t4[538ULL] = X[57ULL];
  t4[539ULL] = 0.0;
  t4[540ULL] = 0.0;
  ...
  t4[551ULL] = X[60ULL];
  t4[552ULL] = 0.0;
  t4[553ULL] = -(X[60ULL] - X[57ULL]) / -1.0;
  t4[554ULL] = X[55ULL];
  t4[555ULL] = X[55ULL] * 0.5;
  t4[556ULL] = X[55ULL] * -1.5;
  t4[557ULL] = 300.0;
  t4[558ULL] = X[57ULL];
  t4[559ULL] = 0.0;
  t4[560ULL] = X[60ULL];
  ...
  t4[563ULL] = X[56ULL];
  t4[564ULL] = 0.0;
  t4[565ULL] = -(X[56ULL] - X[57ULL]) / -1.0;
  t4[566ULL] = X[55ULL];
  t4[567ULL] = X[55ULL] * -0.5;
  t4[568ULL] = X[55ULL] * -0.5;
  t4[569ULL] = 300.0;
  ...
  t4[580ULL] = X[61ULL];
  t4[581ULL] = 0.0;
  t4[582ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[583ULL] = X[61ULL];
  t4[584ULL] = 0.0;
  t4[585ULL] = -(X[61ULL] -
                 ...
                 -6.25) / -1.0;
  t4[586ULL] = X[18ULL];
  t4[587ULL] = X[18ULL] * 0.33333333333333331;
  t4[588ULL] = X[18ULL] * -1.3333333333333333;
  t4[589ULL] = 300.0;
  ...
  t4[592ULL] = X[61ULL];
  t4[593ULL] = X[57ULL];
  t4[594ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[595ULL] = X[57ULL];
  t4[596ULL] = 0.0;
  t4[597ULL] = -(X[57ULL] -
                 ...
                 -6.25) / -1.0;
  t4[598ULL] = X[18ULL];
  t4[599ULL] = X[18ULL] * -0.33333333333333331;
  t4[600ULL] = X[18ULL] * -0.66666666666666663;
  t4[601ULL] = 300.0;
  t4[602ULL] = 0.0;
  ...
  t4[685ULL] = X[73ULL];
  t4[686ULL] = 0.0;
  t4[687ULL] = -(X[73ULL] - X[69ULL]) / -1.0;
  t4[688ULL] = t31;
  t4[689ULL] = t31 * 0.60000000000000009;
  t4[690ULL] = t31 * -1.6;
  t4[691ULL] = 300.0;
  t4[692ULL] = X[69ULL];
  t4[693ULL] = 0.0;
  ...
  t4[697ULL] = X[64ULL];
  t4[698ULL] = 0.0;
  t4[699ULL] = -(X[64ULL] - X[69ULL]) / -1.0;
  t4[700ULL] = X[67ULL];
  t4[701ULL] = X[67ULL] * -0.6;
  t4[702ULL] = X[67ULL] * -0.39999999999999997;
  t4[703ULL] = 300.0;
  t4[704ULL] = X[71ULL];
  t4[705ULL] = 0.0;
  t4[706ULL] = 0.0;
  ...
  t4[717ULL] = X[74ULL];
  t4[718ULL] = 0.0;
  t4[719ULL] = -(X[74ULL] - X[71ULL]) / -1.0;
  t4[720ULL] = t33;
  t4[721ULL] = t33 * 0.55555555555555569;
  t4[722ULL] = t33 * -1.5555555555555558;
  t4[723ULL] = 300.0;
  t4[724ULL] = X[71ULL];
  t4[725ULL] = 0.0;
  t4[726ULL] = X[74ULL];
  ...
  t4[729ULL] = X[69ULL];
  t4[730ULL] = 0.0;
  t4[731ULL] = -(X[69ULL] - X[71ULL]) / -1.0;
  t4[732ULL] = X[68ULL];
  t4[733ULL] = X[68ULL] * -0.55555555555555558;
  t4[734ULL] = X[68ULL] * -0.44444444444444448;
  t4[735ULL] = 300.0;
  t4[736ULL] = X[72ULL];
  t4[737ULL] = 0.0;
  t4[738ULL] = 0.0;
  ...
  t4[749ULL] = X[75ULL];
  t4[750ULL] = 0.0;
  t4[751ULL] = -(X[75ULL] - X[72ULL]) / -1.0;
  t4[752ULL] = X[70ULL];
  t4[753ULL] = X[70ULL] * 0.5;
  t4[754ULL] = X[70ULL] * -1.5;
  t4[755ULL] = 300.0;
  t4[756ULL] = X[72ULL];
  t4[757ULL] = 0.0;
  t4[758ULL] = X[75ULL];
  ...
  t4[761ULL] = X[71ULL];
  t4[762ULL] = 0.0;
  t4[763ULL] = -(X[71ULL] - X[72ULL]) / -1.0;
  t4[764ULL] = X[70ULL];
  t4[765ULL] = X[70ULL] * -0.5;
  t4[766ULL] = X[70ULL] * -0.5;
  t4[767ULL] = 300.0;
  ...
  t4[778ULL] = X[76ULL];
  t4[779ULL] = 0.0;
  t4[780ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[781ULL] = X[76ULL];
  t4[782ULL] = 0.0;
  t4[783ULL] = -(X[76ULL] -
                 ...
                 -6.25) / -1.0;
  t4[784ULL] = X[20ULL];
  t4[785ULL] = X[20ULL] * 0.33333333333333331;
  t4[786ULL] = X[20ULL] * -1.3333333333333333;
  t4[787ULL] = 300.0;
  ...
  t4[790ULL] = X[76ULL];
  t4[791ULL] = X[72ULL];
  t4[792ULL] = Nacelle_Yaw_System_Servomotor_Rotational_Simscape_Intf_C_w *
    -6.25;
  t4[793ULL] = X[72ULL];
  t4[794ULL] = 0.0;
  t4[795ULL] = -(X[72ULL] -
                 ...
                 -6.25) / -1.0;
  t4[796ULL] = X[20ULL];
  t4[797ULL] = X[20ULL] * -0.33333333333333331;
  t4[798ULL] = X[20ULL] * -0.66666666666666663;
  t4[799ULL] = 300.0;
  t4[800ULL] = 0.0;
